...
<meta http-equiv="refresh" content="3000; url=showut5.html">
<script type="text/javascript" language="JavaScript" src="FusionCharts.js"></script> 
<title>Rake UT Coverage - DCM_CP_SlaveSymbol_UT_NQST</title> 
</head> 
		...
		<tr>
			<td> 
				...
				<script type="text/javascript"> 
					...
					chart.setDataURL("FusionCharts/Data/DCM_CP_SlaveSymbol_UT_NQST.xml");       
					chart.render('Line'); 
				</script> 
				</div> 
			</td>  
