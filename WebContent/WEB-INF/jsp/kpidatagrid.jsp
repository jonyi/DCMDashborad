...
function add_div()
{
    ...
    o.id="m"+domid
    $('dom0').appendChild(o)
    o.innerHTML="<h1><span>dom"+domid+"</span><font onclick='del_div(this)'>x</font></h1><div class=nr>add new datagrid</div>"
...
<body>
	<div id="bar" style="height: 400px; background: #eee;"></div>
	<input type="button" value="remove block" onclick="mov();" />
	<input type="button" value="add block" onclick="show();" />
	<input type="button" value="add DIV" onclick="add_div();">
	<div class=content>
		<div class=left id=dom0>
			<div class=mo id=m0>
				<h1>
					<span>dom0</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m1>
				<h1>
					<span>dom1</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m2>
				<h1>
					<span>dom2</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m3>
				<h1>
					<span>dom3</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
		</div>
		<div class=center id=dom1>
			<div class=mo id=m4>
				<h1>
					<span>dom4</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m5>
				<h1>
					<span>dom5</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m6>
				<h1>
					<span>dom6</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m7>
				<h1>
					<span>dom7</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
		</div>
		<div class=right id=dom2>
			<div class=mo id=m8>
				<h1>
					<span>dom8</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m9>
				<h1>
					<span>dom9</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m10>
				<h1>
					<span>dom10</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
			<div class=mo id=m11>
				<h1>
					<span>dom11</span><font onclick="del_div(this)">x</font>
				</h1>
				<div class="nr"></div>
			</div>
		</div>
